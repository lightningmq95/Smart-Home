...
def text_detected(text):
    global displayed_text, response_text
...
functions = {
    "Add Person": lambda: add_user(on_click=login),
    "Login": lambda: pg_login(on_click=login),
    "Integrated Page": integrated_page,
